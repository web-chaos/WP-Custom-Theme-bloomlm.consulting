...
?>
	...
	<main id="primary" class="site-main">
		...
		<?php
			$taxonomy_prefix = 'reviews';
			$term_id = get_queried_object_id();
			$term_id_prefixed = $taxonomy_prefix .'_'. $term_id;
			
			if( get_field( 'contact_form', $term_id_prefixed ) ){ ?>
			<section class="new-leave-request-black ptb-100">
				<div class="container">
					<div class="new-leave-request-black__wrapper">
						<div class="new-leave-request-black__column">
							<h2 class="new-leave-request-black__title"><?php echo get_field( 'title', $term_id_prefixed ); ?></h2>
							<p class="new-leave-request-black__description"><?php echo get_field( 'description', $term_id_prefixed ); ?></p>
						</div>
						<div class="new-leave-request-black__form">
							<?php echo get_field( 'contact_form', $term_id_prefixed ); ?>
							<p class="new-leave-request-black__policy"><?php echo get_field( 'form_policy_text', $term_id_prefixed ); ?></p>
						</div>
					</div>
				</div>
			</section>
