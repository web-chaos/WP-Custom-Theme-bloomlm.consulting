<section class="request">
    <div class="container">
        <div class="request__wrapper">
            <h2 class="request__title"><?php echo get_sub_field( 'title' ); ?></h2>
            <?php if( get_sub_field( 'description' ) ){ ?>
                <div class="request__description"><?php echo get_sub_field( 'description' ); ?></div>
            <?php } ?>
            <a href="#request-popup" data-fancybox class="request__button button"><?php echo esc_html__( 'Оставить заявку', 'bloomlm' ); ?></a>
        </div>
    </div>
</section>

<?php if( get_sub_field( 'contact_form' ) ){ ?>
    <div id="request-popup" class="bloomlm-popup" style="display: none;">
