                ...
                <?php $countForm = 0; while ( have_rows( 'plans' ) ) { the_row(); $countForm++; ?>
                    <div class="plan">
                        ...
                        <?php if( get_sub_field( 'form' ) ){ ?>
                            <a href="#plan-popup<?php echo $countForm; ?>" class="button <?php if( $countForm == 1 || $countForm == 3 ) echo "btn-red"; ?>" data-fancybox><?php echo esc_html__( 'Выбрать', 'bloomlm' ); ?></a>
