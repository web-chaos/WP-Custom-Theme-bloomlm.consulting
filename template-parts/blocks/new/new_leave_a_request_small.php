<section class="cta-block-small">
    <div class="container">
        <div class="cta-block-small__wrapper">
            <h2 class="cta-block-small__title"><?php echo get_sub_field( 'title' ); ?></h2>
            <a href="#cta-block-small" class="button" data-fancybox><?php echo esc_html__( 'Оставить заявку ', 'bloomlm' ); ?></a>
        </div>
    </div>
</section>
<?php if( get_sub_field( 'contact_form' ) ){ ?>
    <div id="cta-block-small" class="bloomlm-popup" style="display: none;">
