<section class="leave-request-large-image ptb-100">
    <div class="container">
        <div class="leave-request-large-image__wrapper">
            <div class="leave-request-large-image__column">
                <h2 class="leave-request-large-image__title"><?php echo get_sub_field( 'title' ); ?></h2>
                <p><?php echo get_sub_field( 'description' ); ?></p>
                <a href="#leave-request-large-image" class="button" data-fancybox><?php echo esc_html__( 'Оставить заявку ', 'bloomlm' ); ?></a>
            </div>
            <?php $image = get_sub_field( 'image' ); ?>
			<?php if ( $image ) { ?>
                <div class="leave-request-large-image__image">
...
<?php if( get_sub_field( 'contact_form' ) ){ ?>
    <div id="leave-request-large-image" class="bloomlm-popup" style="display: none;">
