<section class="awards ptb-100">
    <div class="container">
        <div class="awards__wrapper">
            <?php $four_column = get_sub_field( 'four_column' ); ?>
            ...
            <?php if ( have_rows( 'columns' ) ) { ?>
                <div class="awards__grid <?php echo $subtitle ? 'grid-one' : ''; ?> <?php if ( $four_column ) echo 'four-column'; ?>">
